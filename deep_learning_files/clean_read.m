%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Training for Machine Learning based APT imaging using partially
% synthetic data
%
% Authors: Malvika Viswanathan, Zhongliang Zu
%
%
%  Objective: ML model to be trained for predicting amplitude and width
...
% rescale width after prediction --> Predicted ML width*150
